# Task 88 Integrate relic acquisition, equip state, and player-facing display on the shared run path acceptance-test generation plan

- Title: Task 88 Integrate relic acquisition, equip state, and player-facing display on the shared run path acceptance-test generation plan
- Status: active
- Branch: task/T88
