# Task 83 Hand off CombatScene card play to the existing CombatService runtime acceptance-test generation plan

- Title: Task 83 Hand off CombatScene card play to the existing CombatService runtime acceptance-test generation plan
- Status: active
- Branch: task/T83
