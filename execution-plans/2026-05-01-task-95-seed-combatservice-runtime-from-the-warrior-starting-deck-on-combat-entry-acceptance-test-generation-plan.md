# Task 95 Seed CombatService runtime from the Warrior starting deck on combat entry acceptance-test generation plan

- Title: Task 95 Seed CombatService runtime from the Warrior starting deck on combat entry acceptance-test generation plan
- Status: active
- Branch: task/T95
