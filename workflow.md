...
4. Chapter 4 modifies only affected pages/tasks. Sparse Overlay additions preserve existing prose and bullets. Scaffold model output cannot perform removal or replacement: review and edit destructive changes manually against the actual page. The generator checks each target again when applying.
