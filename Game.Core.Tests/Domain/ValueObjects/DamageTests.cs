...
{
    [Fact]
    public void ShouldEffectiveAmountIsNeverNegative_WhenExecuted()
    {
        // Arrange
    ...
    [InlineData(0, 0)]
    [InlineData(5, 5)]
    public void ShouldEffectiveAmountClampsNegativeAndKeepsPositive_WhenExecuted(int rawAmount, int expected)
    {
        // Arrange
