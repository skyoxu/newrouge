...
- Decision:
  ...
  - Execute all declared tests against an isolated, identified commit or workspace snapshot. Positive nonempty test reports, process success and no skipped tests are required for runtime verification.
  - Distinguish planning, domain composition, scene method and engine input evidence. The reward pilot does not establish whole-MVG or human gameplay acceptance.
