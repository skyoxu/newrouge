...
将 LegacyProject 的 LegacyUIFramework 19 + Tailwind CSS UI 迁移到 newrouge 的 Godot Control 节点系统，保持功能等价性与可测试性。

---

## 技术栈对比

| 层次 | LegacyProject (Web) | newrouge (Godot) |
|-----|---------------|------------------|
