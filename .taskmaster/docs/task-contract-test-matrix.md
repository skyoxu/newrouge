...
### NG-0006 (.taskmaster/tasks/tasks_back.json)

- 标题：Set up Godot autoloads and composition root
- 状态：pending
- layer：ci
- taskmaster_id：13
- 事件：`core.run.started`
...
### GM-0113 (.taskmaster/tasks/tasks_gameplay.json)
