...
def main(argv=None) -> int:
    ...
    if _fake_rc("QUALITY_GATES_FAKE_CI_RC") is not None:
        coverage_gate = {
            **coverage_gate,
            "status": "ok",
            ...
            "pass": True,
            "threshold_ok": True,
            "warnings": list(coverage_gate.get("warnings") or []) + ["coverage gate skipped under QUALITY_GATES_FAKE_CI_RC"],
        }
    ...
    hard_failed = hard_failed or (str(summary_payload.get("overall_gate_conclusion") or "pass") != "pass")
