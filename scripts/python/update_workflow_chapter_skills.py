...
SKILLS = {
    ...
    "workflow-chapter5-semantics-stabilization": {
        ...
        "steps": [
            ...
            "Run global orphan/omission reconciliation before task-scoped checks; missing_in_ch3/orphan_delivery_semantic must not depend on task.semantic_refs.",
            "Use the existing lightweight lane to stabilize acceptance, then bind every acceptance to Requirement/ADR/Contract plus test refs and rerun reconciliation.",
