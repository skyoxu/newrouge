...
SKILLS = {
    ...
    "workflow-chapter3-task-triplet-baseline": {
        ...
        "steps": [
            "Resolve init versus add, allocate a trigger_run_id, and call dev_cli.py refresh-knowledge --source chapter3 --trigger-run-id <run-id> --begin-run before expensive/model-backed work so interrupted runs still leave Last Attempt evidence.",
