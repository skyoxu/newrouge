    ...
    commands = [
        ...
        },
        {
            ...
            "cmd": [
                ...
                "scripts.sc.tests.test_acceptance_testgen_red",
                "scripts.sc.tests.test_generate_tests_from_acceptance_refs",
                "scripts.sc.tests.test_sc_test_refs",
                "scripts.sc.tests.test_build_tdd_orchestration",
                "scripts.sc.tests.test_check_tdd_execution_plan",
                "scripts.sc.tests.test_review_technical_debt",
                "scripts.sc.tests.test_llm_review_prompt_shaping",
                "scripts.sc.tests.test_llm_review_runtime_budget",
                "scripts.sc.tests.test_llm_review_needs_fix_fast",
                "scripts.sc.tests.test_llm_review_backend_cli",
                "scripts.sc.tests.test_agent_to_agent_review",
                "scripts.sc.tests.test_agent_review_contract",
                "scripts.sc.tests.test_agent_review_policy",
                ...
                "scripts.sc.tests.test_pipeline_sidecar_protocol",
                ...
                "scripts.python.tests.test_agent_context_routing",
