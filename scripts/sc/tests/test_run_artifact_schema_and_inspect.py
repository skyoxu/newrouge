...
HAS_REPLAY_FIXTURES = (
    (FIXTURE_ROOT / "pipeline_pass" / "logs" / "ci" / "2026-03-22" / "sc-review-pipeline-task-7" / "latest.json").exists()
    and (FIXTURE_ROOT / "local_hard_fail" / "logs" / "ci" / "2026-03-22" / "local-hard-checks-latest.json").exists()
)
...
@unittest.skipUnless(HAS_REPLAY_FIXTURES, "run_replay fixtures are not present in this repository")
